    ...
    <div class="container-fluid">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th>
              <a href="/admin/blog?page={{ $blog->currentPage() }}&order_by=name&order_dir={{ session('blog.order_dir') == 'asc' ? 'desc' : 'asc' }}" 
      ...
      {{ $blog->appends(['order_by' => session('blog.order_by'), 'order_dir' => session('blog.order_dir')] )->links() }}
    </div>
  </section>
