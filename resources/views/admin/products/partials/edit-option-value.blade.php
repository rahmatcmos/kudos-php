<div class="modal fade" id="modal-edit-option-value" tabindex="-1" role="dialog">
  {{ Form::open(['url' => '/admin/products/'.$product->id.'/update-option-value']) }}
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">{{ trans('crud.edit') }} {{ trans('options.option') }}</h4>
        </div>
